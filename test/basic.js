...
describe('Compiler', function () {
  it('Generates well formed code', function (done) {
    ...
    var context = new vm.createContext({pugVDOMRuntime: pugVDOMRuntime,variable: 1, msg: 'Blop', friends: 10, inputs: [], echo: function (s) { return s }})
  ...
  it('Generates a module template', function (done) {
    ...
    var tree = tpl({variable: 1, msg: 'Blop', friends: 10, inputs: [], echo: function (s) { return s }}, vdom)
    assert.ok(tree)
    done()
  })
